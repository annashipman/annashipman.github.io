---
anchor_id: eng-exec-translation
title: "The Engineer to Executive Translation Layer"
canonical_url: 'https://refactoring.fm/p/the-engineer-executive-translation'
tags: [Leadership, Technology, 'Career development']
layout: blog_post
---
...
1. The translation layer — from engineering to executives.
1. How to translate — for success and profit!
...
### Your boss has a boss, and so does your boss’s boss
...
<div class="quote">
    <h3>Tip</h3>
    <p>If you have an opportunity to talk to your exec team, ask questions.</p>
    <p>A question that shows curiosity about the business at a strategic level will not only give you useful and interesting answers, it will also show you in a good light as someone who is genuinely interested in these things.</p>
    <p>For example “What would you say are the two or three forces or stakeholders that most shape our company’s direction right now?”</p>
</div>
...
### Execs are short on time because they have more areas to oversee
...
<img src="/img/eng-to-exec-translation-layer.jpg" alt="" style="max-width: 100%; height: auto; display: block; border: 0;">
...
### If you are speaking directly to other execs, you need the translation layer
...
### You should be the translation layer
...
<div class="quote">
    “Our build times have doubled, which means engineers are losing around two hours a week waiting on builds; the equivalent of a full headcount lost to inefficiency.”
</div>
...
### Make it brief — one page, 5 slides, 5 minutes
...
<div class="quote">
<h3>Examples</h3>
<p>Here are some example exec summaries. For a document:</p>
<ul><li>This proposal recommends consolidating our infrastructure onto a single cloud provider to reduce operating costs by 20% over three years, improve reliability, and accelerate feature delivery. The alternative is to retain our split between AWS and Azure. The work will reduce capacity of the platform team by 50% for six months, delaying completion of the work on pipelines until Q4 2026.</li>
<li>We request an additional budget of £50k for the engineering team to have access to an AI coding assistance tool. We have demonstrated in our trial that use of Cursor increases throughput of work by 25% meaning over a year we would deliver extra features equivalent to the salary of four additional engineers, therefore this would pay for itself by end Q1 next year.</li></ul>
<p>In a conversation you might say:</p>
<ul><li>“I want to propose we start upgrading our data handling now rather than in Q3 as planned because our latest planning session raised a flag that we may not hit the deadline. We’d have to pause the work on the new dashboards to do that.”</li>
<li>“There’s a strong business case for investing more in developer experience in next year’s budget. I can show you the ROI calculation we’ve done, but I would like your take before we move forward with the budget preparation.”</li></ul>
</div>
...
- You don’t need to say “we encrypt all sensitive data at rest and in transit” — you can say “we ensure sensitive data is fully protected”.
- You don’t need to say “we implemented circuit breakers and retries in our microservices” — you can say “we made the system more resilient”, or even “we did some work that reduced outages”.
...
*This post originally appeared as a guest post on Luca Rossi's newsletter, [Refactoring](https://refactoring.fm/p/the-engineer-executive-translation).*
