...
He talks about the personality ethic (i.e. techniques) vs the character ethic (i.e. things like integrity, humility). His contention is that it's only the latter that will actually make a difference. If you follow techniques but they don't come "inside out" then people will be able to tell.
