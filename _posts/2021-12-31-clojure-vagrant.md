...
![Asking for help on Twitter](/img/twitter/asking_for_help.png)
...
![CPUs could share a core](/img/twitter/cpus_with_shared_core.png)
...
![CPU cap could be the issue](/img/twitter/cpu_cap.png)
...
![Garbage collection could be the issue](/img/twitter/gc_options.png)
...
![With these options, Philip Wigg's ran much faster](/img/twitter/philipwigg_results.png)
...
![JDK misinterprets number of resources? 1](/img/twitter/jdk_misinterpreting_resources_1.png)

![JDK misinterprets number of resources? 2](/img/twitter/jdk_misinterpreting_resources_2.png)
